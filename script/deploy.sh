...
if [ -z $IS_GREEN  ];then # blue라면 (IS_GREEN이 비어 있다면)
  ...
  REQUEST=$(curl http://ec2-43-201-1-107.ap-northeast-2.compute.amazonaws.com:8080) # green으로 request
  ...
  while [ 1 = 1 ]; do
    ...
    sleep 3
    REQUEST=$(curl http://ec2-43-201-1-107.ap-northeast-2.compute.amazonaws.com:8081) # blue로 request
